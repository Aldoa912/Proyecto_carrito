...
# 9 "configSensorUltrasonico.c" 2

# 1 "./configSensorUltrasonico.h" 1
# 11 "./configSensorUltrasonico.h"
void tmr1_init(void);
float medir_distancia(void);
# 10 "configSensorUltrasonico.c" 2
...
float medir_distancia() {
    ...
    unsigned int echo_duration = TMR1 * 4;


    float distancia = echo_duration / 58.0;
